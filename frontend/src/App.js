...
const Home = () => {
  ...
  const analyisesketch = async (sketch) => {
    ...
    try {
      ...
      return response.data.similarity_score_clip; // Get similarity score
    } catch (error) {
    ...
    <div className="container">
      ...
      {showPopup && (
        <div className="popup-overlay">
          <div className="popup-box">
            ...
            <p>2. Sketch image in same pose but in the shape of a real animal</p>
      ...
      {selectedImage && (
        <div className="image-sketch-container">
          ...
          <div className="sketch-box">
            ...
            <ReactSketchCanvas
              ...
              width="100%"
              height="100%"
              strokeWidth={isEraser ? 15 : 3} // Increase stroke width for eraser
        ...
        <div className="action-buttons">
            ...
            <button onClick={() => setShowSavePopup(true)}>Save Sketch</button> {/* Opens save confirmation popup */}
      ...
      {showSavePopup && (
        <div className="popup-overlay">
          <div className="popup-box">
            <h2>Confirm Save</h2>
            <p>Are you sure you want to save this sketch?</p>
            <button onClick={saveSketch}>Yes, Save</button>
